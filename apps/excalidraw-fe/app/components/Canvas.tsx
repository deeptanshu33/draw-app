...
import { Pencil, MousePointer, Circle } from 'lucide-react';
    ...
    return (
        <div style={{height: "100vh", overflow:"hidden"}} className="bg-white relative h-screen">
            ...
            <div className="fixed top-4 left-[40%] z-10 flex gap-1 bg-slate-600 rounded-2xl text-white">
                <button onClick={()=>{setTool('pointer')}} className={`p-4 rounded ${tool==="pointer"?"text-red-400":"text-white"}`}><MousePointer/></button>
